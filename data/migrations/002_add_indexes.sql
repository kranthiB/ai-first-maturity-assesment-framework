...
-- Performance indexes for AFS Assessment Framework
...
-- Text search indexes (where supported)
-- Note: Syntax varies by database - implement based on deployment target
-- CREATE INDEX idx_assessments_team_search ON assessments USING GIN(to_tsvector('english', team_name));
-- CREATE INDEX idx_questions_text_search ON questions USING GIN(to_tsvector('english', question));
