...
-- Schema Migrations
-- ========================================
INSERT OR IGNORE INTO schema_migrations VALUES('001','Initial schema creation','2025-09-04 16:06:55');
INSERT OR IGNORE INTO schema_migrations VALUES('002','Add performance indexes','2025-09-04 16:06:55');
INSERT OR IGNORE INTO schema_migrations VALUES('003','Add analytics tables and views','2025-09-04 16:06:55');
...
-- Sections Data
-- ========================================
INSERT INTO sections (id, name, description, display_order, color, icon, created_at, updated_at) VALUES 
('FC', 'FOUNDATIONAL CAPABILITIES', 'Core building blocks for AI-driven development, including infrastructure, team skills, code generation processes, and knowledge management systems that enable basic AI integration into software engineering workflows', 1, '#3b82f6', 'fas fa-foundation', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('TC', 'TRANSFORMATION CAPABILITIES', 'Advanced capabilities that fundamentally transform how software is built, including intelligent architecture translation, autonomous testing, smart CI/CD, monitoring systems, and legacy modernization using AI', 2, '#10b981', 'fas fa-magic', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI', 'ENTERPRISE INTEGRATION', 'Enterprise-scale capabilities for integrating AI development practices across the organization, including data governance, vendor management, system integration, cost optimization, scalability, and business continuity', 3, '#f59e0b', 'fas fa-building', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG', 'STRATEGIC GOVERNANCE', 'Leadership and governance frameworks for responsible, compliant, and strategically aligned AI adoption, including ethics, performance measurement, IP management, risk management, change management, and future readiness', 4, '#8b5cf6', 'fas fa-shield-alt', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- ========================================
-- Areas Data
-- ========================================
INSERT OR IGNORE INTO areas (id, section_id, name, description, display_order, timeline_l1_l2, timeline_l2_l3, timeline_l3_l4, created_at, updated_at) VALUES 
-- Foundational Capabilities Areas
('FC-AIT', 'FC', 'AI Infrastructure & Tooling', 'Deployment and management of AI development tools, platforms, and infrastructure to support team productivity and collaboration', 1, '6-8 weeks', '8-10 weeks', '16-20 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('FC-ALS', 'FC', 'Team AI Literacy & Skills', 'Development of team competencies in AI tools, prompt engineering, and AI-first development methodologies', 2, '6-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('FC-CGR', 'FC', 'Code Generation & Review', 'Integration of AI assistance in code creation, review, and quality assurance processes', 3, '6-8 weeks', '8-10 weeks', '16-20 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('FC-DKM', 'FC', 'Documentation & Knowledge Management', 'Use of AI to automate and enhance documentation creation, maintenance, and knowledge discovery', 4, '5-6 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Transformation Capabilities Areas
('TC-IAT', 'TC', 'Intent-to-Architecture Translation', 'AI-powered translation of business requirements and intent into technical architecture and system design', 1, '6-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('TC-ATQ', 'TC', 'AI-Driven Testing & Quality Assurance', 'Automation of testing processes using AI for test generation, execution, maintenance, and quality prediction', 2, '7-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('TC-CID', 'TC', 'Continuous Integration & Deployment', 'AI-enhanced CI/CD pipelines with intelligent decision-making, optimization, and automated deployment strategies', 3, '6-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('TC-MOB', 'TC', 'Monitoring & Observability', 'AI-powered system monitoring, anomaly detection, incident response, and predictive issue prevention', 4, '9-12 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('TC-LSM', 'TC', 'Legacy System Modernization', 'AI-assisted analysis, planning, and execution of legacy system transformation and modernization initiatives', 5, '12-15 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Enterprise Integration Areas
('EI-DGM', 'EI', 'Data Governance & Management', 'Governance frameworks and management systems for data used in AI development, ensuring compliance and quality', 1, '12-15 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI-VTS', 'EI', 'Vendor & Tool Standardization', 'Enterprise-wide standardization of AI vendors, tools, and platforms with strategic partnership management', 2, '12-15 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI-IES', 'EI', 'Integration with Enterprise Systems', 'Connection and integration of AI development tools with existing enterprise systems (ERP, CRM, ITSM, etc.)', 3, '12-15 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI-CMR', 'EI', 'Cost Management & ROI Tracking', 'Financial management, cost optimization, and return-on-investment measurement for AI development initiatives', 4, '12-15 months', '18-24 months', '30-36 months', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI-PSM', 'EI', 'Performance & Scalability Management', 'Management of AI development practices scalability across teams, projects, and organizational growth', 5, '12-15 weeks', '15-18 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('EI-BCD', 'EI', 'Business Continuity & Disaster Recovery', 'Resilience planning and disaster recovery capabilities for AI-dependent development processes and systems', 6, '7-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Strategic Governance Areas
('SG-AER', 'SG', 'AI Ethics & Responsible AI', 'Frameworks and practices ensuring ethical, fair, and responsible use of AI in software development', 1, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-PMV', 'SG', 'Performance Measurement & Value Realization', 'Systematic measurement and optimization of business value delivered through AI-first development practices', 2, '6-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-IPM', 'SG', 'Intellectual Property Management', 'Management of intellectual property concerns and legal compliance for AI-generated code and content', 3, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-RMS', 'SG', 'Risk Management & Security', 'Identification, assessment, and mitigation of risks associated with AI-powered development processes', 4, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-OCM', 'SG', 'Organizational Change Management', 'Management of organizational transformation to AI-first development culture, processes, and operating models', 5, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-CAC', 'SG', 'Cross-functional AI Collaboration', 'Coordination and collaboration between AI agents and humans across different functional domains', 6, '7-8 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-REC', 'SG', 'Regulatory Compliance', 'Compliance management for AI development activities with applicable laws, regulations, and industry standards', 7, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('SG-IFR', 'SG', 'Innovation & Future Readiness', 'Strategic preparation for emerging AI technologies and continuous innovation in development practices', 8, '8-10 weeks', '10-12 weeks', '20-24 weeks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- ========================================
-- Questions Data
-- ========================================
INSERT OR IGNORE INTO questions (id, area_id, question, level_1_desc, level_2_desc, level_3_desc, level_4_desc, display_order, is_active, created_at, updated_at) VALUES 
-- Foundational Capabilities Questions
('FC-AIT-01', 'FC-AIT', 'What level of AI development tools and infrastructure does your team currently have in place?', 'No AI tools in use', 'Basic AI assistants (GitHub Copilot, ChatGPT) with individual usage', 'Standardized AI toolchain with team-wide adoption', 'Enterprise-grade AI platform with integrated workflows', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('FC-ALS-01', 'FC-ALS', 'How would you assess your team''s AI literacy and prompt engineering capabilities?', 'Limited AI awareness, no formal training', 'Basic AI understanding, informal learning', 'Structured AI training programs, competent prompt engineering', 'Advanced AI expertise, AI-first mindset across team', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('FC-CGR-01', 'FC-CGR', 'To what extent does AI assist in your code generation and review processes?', 'Manual coding with no AI assistance', 'Occasional AI suggestions for code completion', 'Regular AI-generated code with human review and integration', 'AI-first development with intelligent code generation and automated reviews', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('FC-DKM-01', 'FC-DKM', 'How does AI support your documentation and knowledge management practices?', 'Manual documentation processes', 'AI assistance for basic documentation tasks', 'Automated documentation generation with AI', 'Intelligent knowledge systems with AI-powered insights and semantic search', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Transformation Capabilities Questions
('TC-IAT-01', 'TC-IAT', 'Can your team translate business requirements into technical architecture using AI?', 'Manual requirement analysis and architecture design', 'AI-assisted requirement clarification and initial design suggestions', 'AI generates architecture proposals from business goals with human validation', 'Automated intent-to-architecture pipeline with semantic traceability', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('TC-ATQ-01', 'TC-ATQ', 'What percentage of your testing processes leverage AI automation?', 'Manual testing with traditional automation (0-25%)', 'Basic AI-assisted test generation (25-50%)', 'Comprehensive AI-driven testing with self-healing capabilities (50-85%)', 'Fully autonomous testing with predictive quality assurance (85%+)', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('TC-CID-01', 'TC-CID', 'How intelligent are your CI/CD pipelines in terms of AI-driven decision making?', 'Traditional CI/CD with manual oversight', 'Basic automated workflows with some AI insights', 'Intelligent pipelines with AI-powered optimization and issue detection', 'Autonomous CI/CD with self-healing and adaptive deployment strategies', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('TC-MOB-01', 'TC-MOB', 'How does AI enhance your system monitoring and incident response?', 'Traditional monitoring with manual alert management', 'AI-enhanced anomaly detection with human response', 'Intelligent monitoring with automated incident classification and initial response', 'Fully autonomous monitoring with predictive issue resolution', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('TC-LSM-01', 'TC-LSM', 'How effectively can AI assist in analyzing and modernizing legacy systems?', 'Manual legacy system analysis and migration', 'AI-assisted code analysis and documentation generation', 'AI-powered migration planning with automated refactoring suggestions', 'Autonomous legacy system transformation with intelligent modernization', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Enterprise Integration Questions
('EI-DGM-01', 'EI-DGM', 'How mature are your data governance practices for AI-driven development?', 'No formal data governance for AI development', 'Basic data classification with manual oversight', 'Systematic data governance with automated compliance checks', 'Advanced data governance with AI-powered data lineage and quality management', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('EI-VTS-01', 'EI-VTS', 'How standardized are your AI tools and vendor relationships across the enterprise?', 'Ad-hoc tool selection with no enterprise standards', 'Basic vendor evaluation with some standardization', 'Enterprise-wide AI tool standards with centralized procurement', 'Strategic AI vendor partnerships with integrated tool ecosystems', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('EI-IES-01', 'EI-IES', 'How well do your AI development tools integrate with existing enterprise systems (ERP, CRM, etc.)?', 'No integration with enterprise systems', 'Basic API integrations with manual configuration', 'Automated integration with enterprise systems using standard connectors', 'Seamless AI-powered integration with intelligent data flow and orchestration', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('EI-CMR-01', 'EI-CMR', 'How effectively do you track and optimize costs associated with AI development tools and infrastructure?', 'No cost tracking for AI development', 'Basic cost monitoring with manual reporting', 'Automated cost tracking with budget controls and optimization recommendations', 'Advanced cost optimization with predictive modeling and automated resource management', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('EI-PSM-01', 'EI-PSM', 'How well do your AI development practices scale across teams and projects?', 'Limited scalability, works for small teams only', 'Moderate scalability with some standardization', 'Good scalability with established patterns and practices', 'Excellent scalability with automated provisioning and intelligent resource allocation', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('EI-BCD-01', 'EI-BCD', 'How robust are your business continuity plans for AI-dependent development processes?', 'No specific continuity plans for AI systems', 'Basic backup and recovery procedures', 'Comprehensive continuity planning with automated failover', 'Advanced resilience with self-healing systems and predictive failure prevention', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- Strategic Governance Questions
('SG-AER-01', 'SG-AER', 'How mature are your AI ethics frameworks and responsible AI practices?', 'No formal AI ethics guidelines', 'Basic awareness of AI ethics with informal policies', 'Established AI ethics framework with clear policies and review processes', 'Comprehensive responsible AI program with automated ethics compliance monitoring', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-PMV-01', 'SG-PMV', 'How do you measure and optimize the business value of AI-first development practices?', 'No specific metrics for AI development impact', 'Basic tracking of AI tool usage and developer satisfaction', 'Comprehensive metrics covering productivity, quality, and speed improvements', 'Advanced analytics with predictive modeling, continuous optimization, and business value correlation', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-IPM-01', 'SG-IPM', 'How do you manage intellectual property concerns related to AI-generated code?', 'No formal IP management for AI-generated content', 'Basic IP policies with manual review processes', 'Comprehensive IP management with automated scanning and validation', 'Advanced IP protection with AI-powered originality verification and legal compliance', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-RMS-01', 'SG-RMS', 'How well do you manage risks associated with AI-generated code and automated processes?', 'No specific AI risk management practices', 'Basic awareness of AI risks with manual oversight', 'Systematic AI risk assessment with established mitigation strategies', 'Advanced AI risk management with continuous monitoring and automated safeguards', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-OCM-01', 'SG-OCM', 'How effectively has your organization managed the transition to AI-first development practices?', 'No formal change management for AI adoption', 'Ad-hoc training and support for AI tool adoption', 'Structured change management with role redefinition and training programs', 'Comprehensive transformation program with new operating models and success metrics', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-CAC-01', 'SG-CAC', 'How well do AI agents and humans collaborate across different domains (development, testing, operations)?', 'Siloed teams with no AI collaboration', 'Basic AI tools used independently by different functions', 'Coordinated AI workflows across multiple functions with human oversight', 'Seamless multi-agent AI collaboration with minimal human intervention', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-REC-01', 'SG-REC', 'How well do you manage regulatory compliance for AI-generated code and automated processes?', 'No specific compliance considerations for AI', 'Basic compliance awareness with manual checks', 'Systematic compliance management with automated validation', 'Advanced compliance orchestration with real-time monitoring and reporting', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('SG-IFR-01', 'SG-IFR', 'How prepared is your organization for emerging AI technologies and practices?', 'Reactive approach to new AI technologies', 'Basic awareness and evaluation of emerging AI trends', 'Systematic evaluation and pilot programs for new AI technologies', 'Strategic innovation programs with early adoption and competitive advantage realization', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- ========================================
-- End of Core Framework Seed Data
-- ========================================
